...
The Tab provides an API for extending scan to other file types. To enable scan for a file type you want, you can write your own scan server. Refer to demo project [ScanSrvWebp](doc:linking-to-pages#ScanSrvWebP Demo Scan Server) for the API details.
